...
[text] means friendly description text shown beneath code.&nbsp;&nbsp;
...
[font-name] is the name of the font used to render the [text] property, defaults to 'Comic Sans MS'.&nbsp;&nbsp;
[font-size] is the size in pixels used to render the [text].&nbsp;&nbsp;
[font-color] is the color used to render the [text], defaults to .&nbsp;&nbsp;
