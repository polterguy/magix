...
using ReedSolomon = MessagingToolkit.QRCode.Codec.Ecc.ReedSolomon;
...
using DebugCanvasAdapter = MessagingToolkit.QRCode.Codec.Util.DebugCanvasAdapter;
using QRCodeUtility = MessagingToolkit.QRCode.Codec.Util.QRCodeUtility;
